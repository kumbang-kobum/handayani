            ...
            if(rs.next()){        
                ...
                if(!(rs.getString(1).length()>16)){
                    if(sukses==true){
                        ...
                        sukses=jur.simpanJurnal(rs.getString("no_retur_jual"),"U","K020 BATAL RETUR PENJUALAN DI "+Sequel.cariIsi("select nm_bangsal from bangsal where kd_bangsal='"+rs.getString("kd_bangsal")+"'").toUpperCase()+", OLEH "+akses.getkode());
                    }
                }
